...
在雷达的分解过程中，可以得到天线，我们使用天线雷达升级。一到六级的花费分别是50、150、200、350、600和1000，最高15级。
...
红雷达也分为三种：防御型、激光型和制空型，也是以属性值最高的方面决定。0级红雷达主属性初始值为+60，有1~3项附加属性。每升一级，主属性+15，并有大约三分之一的概率加一级附加属性。其养成路线与金雷达基本一致，但有以下两点不同：
