...
* 等量的肉舰防御，和输出舰火力带来的期望收益是等效的，因此肉舰的60点防御、输出舰的60点火力设定为+1分。
* 肉舰在舰队中对输出的贡献大概是输出舰的五分之一左右，因此肉舰的60点火力，设定为+0.2分。
* 输出舰被击垮的时间大概是肉舰的五分之一左右，因此输出舰的60点防御，设定为+0.2分。
* 机舱在雷达系统中比较鸡肋，每级的兵力加成居然和防御相同（都是+60）。而60点的防御每被打一次，就能为战舰省下60点的兵力。一艘肉舰在被击毁前大约被攻击十次，因此兵力的评分设定为防御的十分之一，1*0.1=0.1；输出舰估计两下就完了，兵力的评分设定为防御的二分之一，0.1\*0.5=0.05。
* 闪避和命中我还不太了解，这里的分数设定是直觉！不过可以确定的是，闪避的作用之于所有舰种是一样的，而命中则在输出舰中用处更大。
* 雷达每升一级-0.5分的原因：在此评价体系中，雷达升一级所增加的分数期望在0.3~0.4分左右，不好的雷达升着升着就成负分了，这也是为了督促大家把负分的雷达分解掉，灌给有潜力的雷达，长久以往得到15个高分的雷达不难。
